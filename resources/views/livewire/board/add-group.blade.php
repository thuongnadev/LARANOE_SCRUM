<div x-data="{ showAddGroupForm: false }" x-on:keydown.escape="showAddGroupForm = false" class="flex flex-col flex-shrink-0 self-start max-h-full w-80 ring-1 bg-gray-100 dark:bg-gray-900 ring-gray-950/10 dark:ring-white/10 rounded-md">
    <template x-if="showAddGroupForm">
    ...
    <button x-show="!showAddGroupForm" @click="showAddGroupForm = true; $nextTick(() => $refs.input.focus())" class="flex items-center justify-start gap-1 w-full p-2" type="button">
